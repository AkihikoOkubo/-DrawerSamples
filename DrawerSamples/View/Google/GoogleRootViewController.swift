//
//  GoogleRootViewController.swift
//  DrawerSamples
//
...
class GoogleRootViewController: UIViewController {
...
extension GoogleRootViewController: DrawerOpenDelegate {
    func openDrawer() {
...
extension GoogleRootViewController: DrawerCloseDelegate {
    func closeDrawer() {
        UIView.animate(withDuration: 0.2) {
